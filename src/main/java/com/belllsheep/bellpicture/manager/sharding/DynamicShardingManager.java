package com.belllsheep.bellpicture.manager.sharding;
...
public class DynamicShardingManager {
    ...
    //private static final String DATABASE_NAME = "bell_picture"; // 配置文件中的数据库名称
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "bell_picture." + tableName) // 确保前缀合法
